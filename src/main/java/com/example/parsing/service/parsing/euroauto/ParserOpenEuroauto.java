package com.example.parsing.service.parsing.euroauto;
...
public class ParserOpenEuroauto {
    ...
    public static void parsing(String link, String linkOut) throws InterruptedException {
        ...
        for (Map.Entry<Integer, Object> mapEntry : map.entrySet()) {
            ...
            List<List<String>> list = EuroautoParsArt.emexParsing(driver, arr[1], arr[0]);
